...
#   --batch_size 8 \
# >> logs/DrRank.bge-reranker-v2-m3.log
...
# CUDA_VISIBLE_DEVICES="0" python -u eval.py \
#   --input_path "data/DrRank.jsonl" \
#   --model_name_or_path "Qwen/Qwen2-7B-Instruct" \
#   --model_type "llm-logit" \
#   --max_doctor_length 2048 \
#   --batch_size 5 \
#   --using_criteria \
# >> logs/DrRank.Qwen2-7B-Instruct.log
...
#   --max_doctor_length 2048 \
#   --batch_size 15 \
# >> logs/DrRank.Qwen2.5-1.5B-Instruct.log &)
...
#   --batch_size 10 \
#   --using_criteria \
# >> logs/DrRank.Qwen2.5-1.5B-Instruct.criteria.log &)
...
#   --batch_size 8 \
#   --label_nums 5 \
# >> logs/DrRank.Qwen2.5-7B-Instruct.log &)
...
#   --query_prefix "我是女性，我正在寻找" \
#   --using_criteria \
# >> logs/DrRank.Qwen2.5-7B-Instruct.criteria.L5.female.log &)
...
#   --query_prefix "我来自城镇，我正在寻找" \
#   --using_criteria \
# >> logs/DrRank.Qwen2.5-7B-Instruct.criteria.L5.urban.log &)
...
#   --query_prefix "我来自乡村，我正在寻找" \
#   --using_criteria \
# >> logs/DrRank.Qwen2.5-7B-Instruct.criteria.L5.rural.log &)
...
#   --batch_size 8 \
#   --label_nums 5 \
# >> logs/DrRank_V2.Qwen2.5-14B-Instruct.log &)
...
#   --using_criteria \
#   --label_nums 5 \
# >> logs/DrRank_V2.Qwen2.5-14B-Instruct.criteria.log &)
...
#   --batch_size 8 \
#   --label_nums 5 \
# >> logs/DrRank.Qwen2.5-32B-Instruct.log &)
...
#   --using_criteria \
#   --label_nums 5 \
# >> logs/DrRank.Qwen2.5-32B-Instruct.criteria.log &)